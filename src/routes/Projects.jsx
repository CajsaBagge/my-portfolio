    ...
    <section className="py-16 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="grid gap-6 sm:grid-cols-2">
          {/* React-projektet */}
          <div className="bg-purple-800 p-6 rounded-xl shadow hover:shadow-lg transition">
          ...
          <div className="bg-purple-800 p-6 rounded-xl shadow hover:shadow-lg transition">
            ...
            <a href="https://github.com/CajsaBagge/HTMLochCSSprojekt.git" className=" hover:underline" target="_blank" rel="noopener noreferrer">
              Se koden på GitHub →
            </a>
          </div>
        </div>
